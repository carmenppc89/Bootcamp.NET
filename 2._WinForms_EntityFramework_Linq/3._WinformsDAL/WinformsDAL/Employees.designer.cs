...
namespace WinformsDAL
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="CarmenEmployees")]
    ...
    partial void Deletelocations(locations instance);
		...
		public EmployeesDataContext() : 
				base(global::WinformsDAL.Properties.Settings.Default.CarmenEmployeesConnectionString, mappingSource)
		{
			OnCreated();
		}
