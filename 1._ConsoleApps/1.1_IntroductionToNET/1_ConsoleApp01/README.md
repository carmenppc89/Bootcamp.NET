...
| 3 | **Average** | Asks how many numbers will be entered, stores them in an array, and computes their average | <img src="../../../IMGs/consoleapp01_03_media.png" width="350" alt="Average exercise"/> |
| 4 | **Compare Dates** | Reads two dates in `dd-mm-aaaa` format and determines which one is more recent | <img src="../../../IMGs/consoleapp01_04_fechas.png" width="450" alt="Compare dates exercise"/> |
