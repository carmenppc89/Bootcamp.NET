...
| 4 | **Compare Dates** | Reads two dates in `dd-mm-aaaa` format and determines which one is more recent | <img src="../../../IMGs/consoleapp01_04_fechas.png" width="300" alt="Compare dates exercise"/> |
| 5 | **camelCase** | Converts a sentence typed by the user into camelCase | <img src="../../../IMGs/consoleapp01_05_camelcase.png" width="300" alt="camelCase exercise"/> |
